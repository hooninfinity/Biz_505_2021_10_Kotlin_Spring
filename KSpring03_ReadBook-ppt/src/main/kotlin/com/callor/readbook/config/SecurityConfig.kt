...
// 프로젝트 설정을 위한 클래스다 라는 선언
@SpringBootConfiguration
// 프로젝트에 Spring Security 설정을 추가한다 
// Spring Security 를 Customizing 하겠다 의미
@EnableWebSecurity
...
//            .permitAll()
        ...
        // authorizeRequest() 함수 아래에 다수의 antMatchers() 를
        // 계속해서 추가할 수 있다
        http.authorizeRequests()
...
//            .passwordParameter("pass")
     ...
     * 5.x 버전 이상에서는 의무적으로 password 를 DB 에 저장하거나
     * 비교연산 등을 할때 반드시 암호화를 하도록 강제하고 있다
     *
